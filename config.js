...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || '𝐑𝐞𝐡𝐚𝐧 𝐑𝐚𝐝',
    ...
    BOT_INFO: process.env.BOT_INFO || '𝐑𝐞𝐡𝐚𝐧 𝐑𝐚𝐝;𝐑𝐞𝐡𝐚𝐧 𝐑𝐚𝐝;923029688227;https://telegra.ph/file/c641d55c971bb42426d2c.jpg',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? '𝐑𝐞𝐡𝐚𝐧 𝐑𝐚𝐝;𝐑𝐞𝐡𝐚𝐧 𝐑𝐚𝐝;https://telegra.ph/file/c641d55c971bb42426d2c.jpg' : process.env.AUDIO_DATA,
    STICKER_DATA: process.env.STICKER_DATA === undefined ? '𝐑𝐞𝐡𝐚𝐧 𝐑𝐚𝐝' : process.env.STICKER_DATA,
    ...
    HEROKU: {
       ...
       SUDO: process.env.SUDO || '923029688227',
       DEBUG: DEBUG
};
